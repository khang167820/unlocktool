...
<head>
    ...
    <style>
        ...
        .price-card.popular::before { content: "Ph? bi?n"; position: absolute; top: -12px; left: 50%; transform: translateX(-50%); background: #6c5ce7; color: white; padding: 5px 20px; border-radius: 20px; font-size: 0.8rem; }
